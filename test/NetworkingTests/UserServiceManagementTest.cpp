...
TEST_F(UserServiceManagementTest, LogoutWithoutLoggingInTest){
  Message message = accountController.logoutUser(firstMessage)[0];
...
TEST_F(UserServiceManagementTest, LoginTest){
    user.reset();
    Message userPrompt = accountController.startLogin(firstMessage)[0];
...
TEST_F(UserServiceManagementTest, LoginTwiceTest){
    ...
    Message secondPrompt = accountController.startLogin(firstMessage)[0];
...
TEST_F(UserServiceManagementTest, RegisterTest){
    user.reset();
    Message message = accountController.startRegister(firstMessage)[0];
...
TEST_F(UserServiceManagementTest, RegisterEscapeTest){
    ...
    Message escapeMessage = accountController.escapeLogin(passwordMessage)[0];
...
TEST_F(UserServiceManagementTest, LoginEscape_WithoutLoginTest){
    user.reset();
    Message escapeMessage = accountController.escapeLogin(firstMessage)[0];
